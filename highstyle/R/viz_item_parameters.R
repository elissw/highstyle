...
print(binwidth_dr)
  ...
  plot1 <- ggplot2::ggplot(df)+
    geom_histogram_highstyle(ggplot2::aes(bgo_10cm_c_s),
  binwidth= binwidth_bgo,color="coral")+
    geom_histogram_highstyle(ggplot2::aes(bgo_40cm_c_s),
  ...
  plot2 <- ggplot2::ggplot(df)+
    geom_histogram_highstyle(ggplot2::aes(DR_10cm_uSv_h),
  binwidth=binwidth_dr,color="coral")+
    geom_histogram_highstyle(ggplot2::aes(DR_40cm_uSv_h),
