...
#' @name geom_density_highstyle
#' @export
geom_density_highstyle <- function(mapping = NULL,
                            data = NULL,
                            ...,
                            linewidth = 0.8,
                            color = "cadetblue",
...
#' Defaults will be overriden if specified otherwise in the arguments. 
#' @name geom_density_ridges_highstyle
#' @export
geom_density_ridges_highstyle <- function(mapping = NULL,
                                   data = NULL,
                                   ...,
                                   alpha = 0.6,
                                   linewidth = 0.8) {
...
#' Defaults will be overriden if specified otherwise in the arguments. 
#' @name geom_bar_highstyle
#' @export
geom_bar_highstyle <- function(mapping = NULL,
                              data = NULL,
                              ...,
                              fill = "cadetblue",
                              width = 0.4) {
...
#' @name geom_histogram_highstyle
#' @export
geom_histogram_highstyle <- function(mapping = NULL,
                                  data = NULL,
                                  ...,
                                  binwidth,
                                  color = "black",
